...
public class FinancialCapitalDetailsFragment extends BusinessBaseFragment {

    public static final String STATUS_ALL = "1";
    public static final String STATUS_NOPAY_STR = "2";
    public static final String STATUS_CHECK_STR = "3";
    ...
    private FinancialOrderAdapter mOrderAdapter;

    private int mPageNo = 1;

    public static FinancialCapitalDetailsFragment newInstance(String orderType) {
        FinancialCapitalDetailsFragment orderFragment = new FinancialCapitalDetailsFragment();
    ...
    protected void onViewCreated(Bundle savedInstanceState) {
        ...
        mOrderAdapter = new FinancialOrderAdapter(mOrderEntities);
...
//        });
    ...
    private void getData(boolean showLoading) {
        ...
        maps.put("type", mOrderType + "");
        EasyHttp.post("/api/financial/cashrecord")
                .params(maps)
